...
const routes = [
...

    {
        ...
        component: () => import(/* webpackChunkName: "index2" */ '../views/companies/CompaniesIndex'),
...

    {
        ...
        component: () => import(/* webpackChunkName: "index2" */ '../views/companies/CompaniesCreate'),
    ...
    },
    {
        ...
        component: () => import(/* webpackChunkName: "index2" */ '../views/companies/CompaniesEdit.vue'),
...

    {
        path: '/auth/register',
        name: 'auth.register',
        component: () => import(/* webpackChunkName: "index2" */ '../views/auth/register'),
...

    {
        path: '/auth/login',
        name: 'auth.login',
        component: () => import(/* webpackChunkName: "index2" */ '../views/auth/login'),
...

    {
        path: '/posts/home',
        name: 'posts.home',
        component: () => import(/* webpackChunkName: "index2" */ '../views/posts/PostsHome'),
...

    {
        path: '/posts/:id/ind',
        name: 'posts.ind',
        component: () => import(/* webpackChunkName: "index2" */ '../views/posts/PostsInd.vue'),
    ...
    },
    {
        path: '/posts/index',
        name: 'posts.index',
        component: () => import(/* webpackChunkName: "index2" */ '../views/posts/PostsIndex'),
...

    {
        path: '/posts/create',
        name: 'posts.create',
        component: () => import(/* webpackChunkName: "index2" */ '../views/posts/PostsCreate'),
    ...
    },
    {
        ...
        name: 'posts.edit',
        // component: CompaniesEdit,
        component: () => import(/* webpackChunkName: "index2" */ '../views/posts/PostsEdit.vue'),
...
// ***********************************************users***********************************
    {
        path: '/users/index',
        name: 'users.index',
        component: () => import(/* webpackChunkName: "index2" */ '../views/users/UsersIndex'),
...

    {
        path: '/users/create',
        name: 'users.create',
        component: () => import(/* webpackChunkName: "index2" */ '../views/users/UsersCreate'),
    ...
    },
    {
        ...
        name: 'users.edit',
        // component: CompaniesEdit,
        component: () => import(/* webpackChunkName: "index2" */ '../views/users/UsersEdit.vue'),
