...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    delete_row: function delete_row(props) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default()["delete"]('/permission/' + props.id).then(function (response) {
        if (response.data === 'ok') {
          _this.permissionDeleteconfirmation();
        }
      });
    },
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('/api/users').then(function (response) {
