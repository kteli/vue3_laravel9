...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.form.id]])]), _hoisted_9]), _hoisted_10])])])])], 64
  /* STABLE_FRAGMENT */
  );
}
