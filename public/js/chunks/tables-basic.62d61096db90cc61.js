...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    delete_row: function delete_row(props) {
      console.log(props.id);

      if (window.confirm('You sure?')) {
        axios__WEBPACK_IMPORTED_MODULE_2___default()["delete"]("/api/users/".concat(props.id));
      }
    },
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                axios__WEBPACK_IMPORTED_MODULE_2___default().get('/api/users').then(function (response) {
    ...
    actions: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function (props) {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_16, [_hoisted_17, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
        ...
        onClick: function onClick($event) {
          return $options.delete_row(props.row);
        }
      }, _hoisted_20, 8
      /* PROPS */
      , _hoisted_18)])];
